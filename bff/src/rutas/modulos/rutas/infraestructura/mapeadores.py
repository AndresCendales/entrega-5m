...
from rutas.seedwork.dominio.repositorios import Mapeador
from rutas.seedwork.infraestructura.utils import unix_time_millis
from rutas.modulos.rutas.dominio.entidades import Ruta, Orden
from rutas.modulos.rutas.dominio.eventos import RutaProgramada, EventoRuta
...
class MapadeadorEventosRuta(Mapeador):
    ...
    def _entidad_a_ruta_programada(self, entidad: RutaProgramada, version=LATEST_VERSION):
        def v1(evento):
            ...
            evento_integracion.service_name = 'rutas'
