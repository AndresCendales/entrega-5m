from ordenes.seedwork.infraestructura.proyecciones import Proyeccion, ProyeccionHandler
from ordenes.seedwork.infraestructura.proyecciones import ejecutar_proyeccion as proyeccion
from ordenes.modulos.ordenes.infraestructura.fabricas import FabricaRepositorio
from ordenes.modulos.ordenes.infraestructura.repositorios import RepositorioOrdenes
from ordenes.modulos.ordenes.dominio.entidades import Orden
from ordenes.modulos.ordenes.dominio.objetos_valor import Ubicacion
from ordenes.modulos.ordenes.infraestructura.dto import Orden as OrdenDTO

from ordenes.seedwork.infraestructura.utils import millis_a_datetime
import datetime
import logging
import traceback
