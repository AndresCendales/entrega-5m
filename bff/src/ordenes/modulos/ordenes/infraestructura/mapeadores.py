""" Mapeadores para la capa de infrastructura del dominio de ordenes
...
from ordenes.seedwork.infraestructura.utils import unix_time_millis
from ordenes.modulos.ordenes.dominio.entidades import Orden, Producto
from ordenes.modulos.ordenes.dominio.eventos import OrdenCreada, EventoOrden
...
class MapadeadorEventosOrden(Mapeador):
    ...
    def _entidad_a_orden_creada(self, entidad: OrdenCreada, version=LATEST_VERSION):
        def v1(evento):
            ...
            evento_integracion.service_name = 'ordenes'
