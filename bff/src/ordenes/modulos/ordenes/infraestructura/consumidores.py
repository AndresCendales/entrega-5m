...
from ordenes.modulos.ordenes.infraestructura.proyecciones import ProyeccionOrdenesLista
from ordenes.seedwork.infraestructura.proyecciones import ejecutar_proyeccion
