...
from ordenes.modulos.ordenes.aplicacion.dto import ProductoDTO, OrdenDTO, UbicacionDTO
...
from ordenes.modulos.ordenes.aplicacion.mapeadores import MapeadorOrden
from ordenes.modulos.ordenes.infraestructura.repositorios import RepositorioOrdenes, RepositorioEventosOrdenes
...
class CrearOrdenHandler(CrearOrdenBaseHandler):
    ...
    def handle(self, comando: CrearOrden):
        ...
        orden.crear_orden(orden) # Aqui se agrega el evento OrdenCreada
